...
@DataJpaTest
public class RestaurantMssqlRepositoryTest {

@Autowired
private RestaurantMssqlRepository mssqlRepository;
...
@Autowired
  ...
  public void should_find_no_restaurant_if_repository_is_empty() {
    Iterable<RestaurantModel> restaurants = mssqlRepository.findAll();
  ...
  public void should_store_restaurants() throws Exception {
    ...
    RestaurantModel restaurant = mssqlRepository.save(restaurantModel);
  ...
  public void should_store_all_restaurants() throws Exception {
    ...
    List<RestaurantModel> restaurants =  mssqlRepository.saveAll(restaurantModels);
