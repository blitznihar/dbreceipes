...
@DataJpaTest
public class RestaurantPostgresqlRepositoryTest {

@Autowired
private RestaurantPostgresqlRepository postgresqlRepository;
...
@Autowired
  ...
  public void should_find_no_restaurant_if_repository_is_empty() {
    Iterable<RestaurantModel> restaurants = postgresqlRepository.findAll();
  ...
  public void should_store_restaurants() throws Exception {
    ...
    RestaurantModel restaurant = postgresqlRepository.save(restaurantModel);
  ...
  public void should_store_all_restaurants() throws Exception {
    ...
    List<RestaurantModel> restaurants =  (List<RestaurantModel>) postgresqlRepository.saveAll(restaurantModels);
